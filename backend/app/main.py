...
from app.routers import auth, deferred, extract, health, intake_recommendations, intakes, patients, questionnaires, reconcile, save
...
def create_app() -> FastAPI:
    ...
    app.include_router(intake_recommendations.router)
